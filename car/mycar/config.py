...
MM1_MAX_REVERSE = 800          # Max throttle to go reverse. The smaller the faster
...
AI_THROTTLE_MULT = 0.935              # this multiplier will scale every throttle value for all output from NN models
